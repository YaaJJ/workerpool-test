    ...
    /******/ var __webpack_modules__ = {
      /***/ 345: /***/ function (
        ...
        Pool.prototype._createWorkerHandler = function () {
          ...
          return new WorkerHandler(overridenParams.script || this.script, {
            ...
            workerThreadOpts:
              overridenParams.workerThreadOpts || this.workerThreadOpts,
      ...
      /***/ 751: /***/ function (
        ...
        function setupWorkerThreadWorker(
          ...
          var worker = new WorkerThreads.Worker(
            script,
            _objectSpread(
              {
                stdout: false,
      ...
      /***/ 744: /***/ function (
        ...
        if (
          ...
          if (
            WorkerThreads /* if there is a parentPort, we are in a WorkerThread */ &&
